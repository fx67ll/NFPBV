<template>
	<div class="login-box" :class="this.isLogin ? 'form-success' : ''" @click="showTips()">
		<div class="container">
			...
			<div class="form" :class="{ 'form-fadeout': this.isLogin, 'form-fadein': !this.isLogin, 'form-shake': !this.isSuccess }">
				...
				<div class="form-register" :class="this.isRegister ? 'form-toggle-show' : 'form-toggle-none'">
					...
					<input v-model="registerForm.confimPassWord" type="password" placeholder="Confirm Password" @keyup.enter="handleRegister()" />
					<input v-model="registerForm.email" type="text" placeholder="Email" @keyup.enter="handleRegister()" />
					<input v-model="registerForm.phone" type="text" placeholder="Phone" @keyup.enter="handleRegister()" />
		...
		>
			...
			<span slot="footer" class="dialog-footer"><el-button type="primary" @click="checkLoginOption()">确 定</el-button></span>
		</el-dialog>
