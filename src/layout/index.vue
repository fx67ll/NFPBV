<template>
	<div class="fx67ll-layout-box">
		...
		<el-menu class="fx67ll-layout-aside" v-if="isAside"
			:class="{ 'fx67ll-layout-aside-open': !isCollapse, 'fx67ll-layout-aside-close': isCollapse }"
			:collapse="isCollapse" :collapse-transition="false" @open="handleOpen()" @close="handleClose()">
			<el-submenu index="1">
				<template slot="title">
					<i class="el-icon-folder-opened"></i>
					<span slot="title">多级导航(演示)</span>
				</template>
				<el-submenu index="1-1">
					...
					<el-menu-item index="1-1-1">
						<span slot="title">
							<i class="el-icon-folder-opened"></i>
							<span slot="title">测试用导航 1-1</span>
						</span>
					</el-menu-item>
					<el-menu-item index="1-1-2">
						<span slot="title">
							<i class="el-icon-folder-opened"></i>
							<span slot="title">测试用导航 1-2</span>
						</span>
					</el-menu-item>
				</el-submenu>
				...
				<el-submenu index="1-3">
					...
					<el-menu-item index="1-3-1">
						<span slot="title">
							<i class="el-icon-folder-opened"></i>
							<span slot="title">测试用导航 3-1</span>
						</span>
					</el-menu-item>
				</el-submenu>
			</el-submenu>
			<el-menu-item index="2">
				...
				<span slot="title">单级导航(演示)</span>
			</el-menu-item>
			<el-menu-item index="3" disabled>
				<i class="el-icon-lock"></i>
				<span slot="title">禁用导航(演示)</span>
			</el-menu-item>
			<el-submenu index="4">
				<template slot="title">
